...
export default function Footer() {
    return (
        ...
        <div id="footer-right">
            ...
            <a target="_blank" href="mailto:me@coen.ovh" rel="noopener noreferrer"><img src="/email.svg" id="mail" alt="Email Icon"/></a>
            <a target="_blank" href="https://github.com/coen-h" rel="noopener noreferrer"><img src="/github-mark-white.svg" id="github" alt="Github Icon"/></a>
        </div>
    </div>
    )
}