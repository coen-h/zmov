...
export default function Header() {
  ...
  return (
    <div className="flex backdrop-blur-xs fixed h-20 max-lg:h-16 w-full bg-gradient-to-b from-gray-950 justify-between max-xs:justify-center items-center px-12 max-2xl:px-5 max-lg:px-3 z-50">
      <Link href='/' className="mr-1 transition-all hover:opacity-50">
      ...
      <div className="flex items-center gap-2">
        <div className="flex items-center relative hover:opacity-80 transition-all">
          <button onClick={handleSearch} className="w-10 h-full absolute left-0 top-1/2 -translate-y-1/2 bg-white/5 p-2 rounded-l-xl hover:bg-white/15 transition-all cursor-pointer">
        ...
        <Link href='/user' className="bg-white/15 rounded-xl transition-all hover:scale-95">
          {user ? (
            <img
